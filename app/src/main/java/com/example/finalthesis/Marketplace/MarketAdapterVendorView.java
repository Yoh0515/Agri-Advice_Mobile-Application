...
public class MarketAdapterVendorView extends RecyclerView.Adapter<MarketAdapterVendorView.MyViewHolder> {

    private ArrayList<MarketData> marketList;
    private Context context;

    public MarketAdapterVendorView(ArrayList<MarketData> marketList,Context context){
    ...
    @NonNull
    @Override
    public MarketAdapterVendorView.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_market, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MarketAdapterVendorView.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView mImage;
        TextView mTitle, mPrice,mUnit, mRating, mReviewCount, mSold;
        LinearLayout mCard;
