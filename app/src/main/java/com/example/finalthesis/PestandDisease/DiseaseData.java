...
public class DiseaseData {
    ...
    public DiseaseData(String title, String iconUrl, String pdfUrl, String plantTitle, String key, String chemical, String damage, String imageUrl, String identify, String physical) {
        this.title = title;
        this.iconUrl = iconUrl;
        this.pdfUrl = pdfUrl;
        this.plantTitle = plantTitle;
